...
static int compare_integers_ptr(const void *left, const void *right)
{
    int *l = *((int **)left);
    int *r = *((int **)right);
    return (*l - *r);
...
static struct cstl_array *create_c_array()
{
    int size   = 10;
    int i      = 0;
    void *p_rv = (void *)0;
...
static struct cstl_deque *create_deque()
{
    int flip                 = 1;
    int i                    = 0;
    int limit                = 20;
...
static struct cstl_set *create_set()
{
...
static struct cstl_map *create_map()
{
    char *char_value[] = {
...
static struct cstl_list *create_slist()
{
...
static void t_cstl_for_each(void)
{
